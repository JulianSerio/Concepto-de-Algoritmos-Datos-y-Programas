...
procedure cargoVector (var v:vAlumno; var dimL:Integer);
var
    aux:alumno;
begin
    dimL:=0;
    leoInfo(aux);
    while (aux.DNI <> -1) and (dimL < dimF) do begin
        dimL:= dimL + 1;
        v[dimL]:= aux;
        leoInfo(aux);
    end;
...
procedure recorroVector (v:vAlumno; dimL:integer; var max1,max2:Integer; var nom1,nom2,ape1,ape2:str; var porcentaje: Real);
var
...
var
    v:vAlumno;
    cantPar,max1,max2,dimL:Integer;
    ape1,ape2,nom1,nom2:str;
    porcentaje:Real;
begin
    cargoVector(v,dimL);
    recorroVector(v,dimL,max1,max2,nom1,nom2,ape1,ape2,porcentaje);
